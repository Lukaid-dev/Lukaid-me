    ...
    <div className="ring-border text-text mx-4 flex flex-col gap-4 rounded-xl p-4 outline-none ring">
      ...
      <div className="text-text pl-4">
        <ul className="list-inside list-disc [&_ul]:pl-8">
          ...
          <li>
            어떤 프로젝트를 진행하더라도{' '}
            <span className="font-bold text-gray-950">먼저 나서서 소통</span>
      ...
      <div className="text-text pl-4">
        <ul className="list-inside list-disc [&_ul]:pl-8">
          ...
          <li>
            파이썬을 사용하면서{' '}
            <span className="font-bold text-gray-950">개발의 즐거움</span>을
            느꼈고, 업무 수행에 필요한 스킬로 플러터, 리액트 등을 학습했습니다.
          </li>
          <li>
            앞으로도 계속해서 새로운 것들을 배우고 다양한 사람들과 소통하며
            성장하여, 언제나{' '}
            <span className="font-bold text-gray-950">도움이 되는 개발자</span>
            가 되고자 합니다.
          </li>
        </ul>
      </div>
